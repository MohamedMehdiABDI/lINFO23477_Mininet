...
if __name__ == '__main__':
    ...
    with open(attack_script, "w") as f:
        f.write(f"internet ./attack_a {args.noma}\n")
        f.write(f"http ./attack_b {args.noma} 0\n")
        f.write(f"ntp ./attack_b {args.noma} 1\n")
        f.write(f"ftp ./attack_b {args.noma} 2\n")
        f.write(f"dns ./attack_b {args.noma} 3\n")
